...
with st.sidebar:
    choose = option_menu("DS Application", ["About", "Preparing", "EDA", "Modeling", "Evaluating"],
...
if choose == "About":    
...
elif choose == "Modeling":

    st.markdown('<p class="font">Modeling</p>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="font">Evaluating</p>', unsafe_allow_html=True)